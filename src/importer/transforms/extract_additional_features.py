        ...
        try:
            ...
            for node in graph.nodes:
                ...
                try:
                    ...
                    thread_utils.thread_safe_print(f"Error analyzing sentiment for node {node}: {pe}")
        except Exception as e:
            thread_utils.thread_safe_print(f"Error initializing sentiment analysis pipeline: {e}")

        thread_utils.thread_safe_print('Additional features extracted and added to graph as node attributes.')
